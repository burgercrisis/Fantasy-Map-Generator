...
const explicitIsoBaseMap = {
  ...
  // West African English-based creoles ΓåÆ West African English Creole base (307)
  "aku": 307,
  ...
  // Malay-based trade creoles ΓåÆ Malay-based Creole base (310)
  "alor-malay": 310,
  "ambonese-malay": 310,
  "baba-malay": 310,
  "balinese-malay": 310,
  ...
  eblaite: 23,
  dilmunite: 23,
  // North Ethiopic / Ge╩╜ez and closely related lects
  "ge-ez": 138,
  "abba-gorgoryos": 138,
  dahalik: 134,
  // Gurage / Outer Ethio-Semitic lects ΓåÆ use dedicated Gurage base (311)
  chaha: 311,
  endegen: 311,
  ezha: 311,
  gafat: 311,
  ...
  zway: 311,
  zay: 311,
  // Harari / Argobba lects ΓåÆ dedicated Harari-Argobba base (312)
  harari: 312,
  ...
  "altai": 225,
  // Karakalpak is a KipchakΓÇôNogai lect; approximate via dedicated Nogai base
  "karakalpak": 295,
  // Khakas is Siberian Turkic; approximate via Kyrgyz-style steppe base
  "khakas": 227,
  // Major modern Turkic languages ΓåÆ dedicated regional bases
  "tur": 16,
  "azerbaijani": 265,
  "kazakh": 225,
  "kyrgyz": 227,
  ...
  "nogai": 295,
  "kalmyk": 296,
  // Other non-Turkic leaf mappings
  "balti": 47,
  "bodo": 63,
  "chin": 62,
  "hokchiu": 68,
  ...
  // Papuan macro families ΓåÆ approximate to dedicated Papuan base (315)
  "awin-pa": 315,
  binanderean: 315,
  bosavi: 315,
  "duna-pogaya": 315,
  ...
  // Tai / TaiΓÇôKadai leaf mappings (Thai / Lao / Zhuang clusters)
  "standard-zhuang": 314,
  bouyei: 314,
  "hezhang-buyi": 314,
  "yei-zhuang": 314,
  ...
  // Kam-Sui, Kra, and Hlai macro and daughter lects ΓåÆ dedicated bases
  "kam-sui": 316,
  "kam-dong": 316,
  "biao-kam-sui": 316,
  "lakkia-kam-sui": 316,
  ...
  // Na-Dene macro family ΓåÆ reuse Navajo base
  "na-dene": 172,

// Dravidian ΓÇô Telugu cluster (Central/South-Central Dravidian, AP/Telangana/Central India)
"gondi": 200,
"kui-dravidian": 200,
"koya": 200,
"madiya": 200,
...
"yerukala": 200,
  ...
  // Dravidian ΓÇô Kannada cluster (Karnataka-focused South Dravidian)
  "tulu": 254,
  "beary": 254,
  "kodava": 254,
  "betta-kurumba": 254,
  ...
  // Dravidian ΓÇô Malayalam cluster (Kerala/Lakshadweep-focused South Dravidian)
  "jeseri": 255,
  "kurichiya": 255,
  "paniya": 255,
  "kanikkaran": 255,
...
const tokenBaseIndexMap = {
  ...
  maghrebi: 18,
  levantine: 18,
  // Ethiopic / Amharic cluster ΓåÆ prefer Amharic base (133)
  ethiopic: 133,
  amharic: 133,
  // Harari / Argobba keywords ΓåÆ dedicated Harari-Argobba base (312)
  harari: 312,
  argobba: 312,
  // Gurage keywords ΓåÆ dedicated Gurage base (311)
  gurage: 311,
  ...
  basque: 20,
  // Generic Celtic macro; more specific Celtic tokens are mapped below
  celtic: 22,
  nigerian: 21,

  // Celtic micro-families with dedicated bases
  welsh: 206,
  breton: 207,
  cornish: 208,
  "scottish-gaelic": 184,
  ...
  // Caucasus (Kartvelian / Nakh / Circassian / Ossetian clusters)
  georgian: 223,
  armenian: 224,
  abkhaz: 237,
  chechen: 238,
  ...
  "north-borneo": 346,
  "greater-north-borneo": 346,
  "land-dayak": 347,
  barito: 347,
  "greater-barito": 347,
  "south-sulawesi": 348,
  "central-south-sulawesi": 348,
  "northern-south-sulawesi": 348,
  "makassar-branch": 348,
  bisaya: 193,
  visayan: 193,
  cebuano: 193,
  ...
  ganza: 145,
  cushitic: 140,
  "highland-east-cushitic": 131,
  "lowland-east-cushitic": 130,
  "macro-somali": 130,
  "somali-languages": 130,
  "somali-western": 130,
  "omo-tana": 130,
  oromoid: 131,
  "saho-afar": 140,
  ...
  amazigh: 331,
  "northern-berber": 331,
  "northern-berber-languages": 331,
  "western-berber": 331,
  "western-berber-languages": 331,
  "zenati-berber": 332,
  "zenati-languages": 332,
  "tuareg-berber": 333,
  "tuareg-languages": 333,
  "standard-moroccan-amazigh": 331,
  "standard-algerian-berber": 332,
  "central-atlas-tamazight": 331,
  kabyle: 332,
  shilha: 331,
  tarifit: 331,
  papuan: 315
...
function main() {
  ...
  function resolveBaseByNameLike(name) {
    ...
    const dehyphen = lower.replace(/[-ΓÇô]+/g, " ").trim();
    ...
    if (prefixStripped && prefixStripped !== lower && !variants.includes(prefixStripped)) {
      ...
      const prefixDehyphen = prefixStripped.replace(/[-ΓÇô]+/g, " ").trim();
