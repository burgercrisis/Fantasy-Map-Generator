...
/**
 * Namebase Integrity Checker
 *
 * Validates namebase files for index and name collisions.
 * Scans all continent-specific namebase files for:
 * - Duplicate index (i:) values
 * - Duplicate names (case-insensitive)
 *
 * Usage:
 *   node tools/validation/check-namebase-integrity.js
