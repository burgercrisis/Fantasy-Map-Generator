 ...
 * Short Base Report
 *
 * Lists all continent-based namebase entries with fewer than 5 cities.
 * Used to identify entries needing city expansion work.
 *
 * Usage:
 *   node tools/validation/report-short-bases.js
