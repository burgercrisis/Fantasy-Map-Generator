...
function main() {
  ...
  // Batch 1: decluster 10 members from the Papuan bases=[360] hub.
  ...
  const targets = {
    ...
    suena: [360, 365],
    korafe: [360, 365, 520],
    "foia-foia": [360, 365, 366],
    hamtai: [360, 366],
    marind: [360, 454, 367],
    boazi: [360, 454, 520, 367],
    "duna-pogaya": [360, 365, 520, 454]
  };
  ...
  console.log("Decluster Papuan [360] batch1 complete");
