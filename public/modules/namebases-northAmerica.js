window.northAmericaNameBases = [
  {
    ...
    "d": "lmtnxzc",
    "m": 0,
    "b": "Tenochtitlan,Mexihco,Texcoco,Xochimilco,Tlaxcallan,Cuauhnahuac,Azcapotzalco,Tlatelolco,Chalco,Tenayuca,Tepotzotlan,Huaxacac,Tlachco,Cuicatlan,Comitlan,Amatlan,Tonanytlan,Xolotlan,Yopico,Teotihuacan,Cholollan,Tizayuca,Apizaco,Huamantla,Contla,Ixtacamaxtitlan,Tetela,Ocotlan,Tonatico,Xalatlaco,Chalchiuhcuecan,Atemaxac,Atlacomolco,Cuauhtitlan,Mazatlan,Acatlan,Coatepec,Huejutla,Ixmiquilpan,Tizatlan,Tollantzinco,Tochtepec,Tequixquiac,Zacualco,Tepecoyo,Chapultepec,Coyoacan,Tlalpan,Malinalco,Tulancingo,Zempoala,Cempoala,Tlalmanalco,Amecatepec,Cuautitlan,Jilotepec,Atlixco,Huaquechula,Chiautla,Tepeaca,Tehuacan,Cuautinchan,Atoyatempan,Tecali,Tepexi,Tlachichuca,Zacatlan,Xicotepec,Chignahuapan,Zacapoaxtla,Cuetzalan,Xalapa,Acajete,Tlacojalpan,Tlacolulan,Tlacotalpan,Tlaltetela,Tlapacoyan,Tlilapan,Tomatlan,Tonayan,Totutla,Xico,Yecuatla,Zacualpan,Zongolica,Zontecomatlan,Acula,Catemaco,Chacaltianguis,Cosamaloapan,Cotaxtla,Ixmatlahuacan,Jamapa,Miahuatlan,Minatitlan,Naolinco,Otatitlan,Panuco,Xochicoatlan,Yahuitlan,Xaltocan,Metepec,Ixtlahuaca,Atlacomulco,Jiquipilco,Aculco,Temascalcingo,Coyotepec,Hueypoxtla,Nextlalpan,Tepetlaoxtoc,Chiconcuac,Tepanohuayan,Cuautlancingo,Tlalnepantla,Tlatilolco,Teotihuakan,Tula,Tullān,Tetzcoko,Cholula,Cholōllān,Tlacopan,Tlakōpan,Mexico,Azkaputzalco,Xōchimilco,Iztapalapa,Iztapalapan,Koyōkan,Milpa Alta,Milpan,Tlahuac,Tlahuak,Iztacalco,Iztakalko,Cuajimalpa,Kuaximalpa,Alvaro Obregon,Alwaru Ubrekun,Benito Juarez,Benitu Huwakis,Cuauhtemoc,Kuahthemok,Miguel Hidalgo,Mikel Hidalku,Venustiano Carranza,Benustianu Karrantsa,Gustavo A. Madero,Kustawu A. Maderu,Tultepec,Tultepek,Tultitlan,Ecatepec,Ekatapek,Coacalco,Koakalko,Huixquilucan,Wixkwikulkan,Naucalpan,Naukalpan,Tlanepantla,Kuautitlan,Cuautitlan Izcalli,Kuautitlan Izkali,Teoloyucan,Teuluwukan,Huehuetoca,Wehwetoka,Zumpango,Tzumpanko,Jaltocan,Jaltokan,Apaxco,Apasko,Tekiskikiak,Weypoxtla,Koyotapek,Melchor Ocampo",
    "status": "COMPLETE"
  },
  {
    "name": "Inuit",
  ...
  },
  {
    ...
    "d": "lnrm",
    "m": 0,
    "b": "Montreal,Trois-Rivieres,Sherbrooke,Gatineau,Saguenay,Longueuil,Levis,Saint-Jean-sur-Richelieu,Laval,Terrebonne,Repentigny,Dollard-des-Ormeaux,Brossard,Saint-Jerome,Blainville,Mirabel,Chateauguay,Saint-Hyacinthe,Joliette,Rouyn-Noranda,Val-d'Or,Saint-Georges,Alma,Amos,Amqui,Baie-Comeau,Baie-Saint-Paul,Beauharnois,Beloeil,Boisbriand,Brownsburg-Chatham,Cabano,Candiac,Cap-de-la-Madeleine,Carleton-sur-Mer,Chambly,Chandler,Charlemagne,Chibougamau,Coaticook,Contrecoeur,Danville,Estérel,Farnham,Fermont,Gaspé,Granby,Grande-Rivière,Hudson,Huntingdon,Kirkland,La Malbaie,La Prairie,La Sarre,La Tuque,Lachute,Lac-Brome,L'Assomption,Magog,Malartic,Maniwaki,Marieville,Matane,Matagami,Mercier,Mont-Joli,Mont-Laurier,Montmagny,New Richmond,Nicolet,Normandin,Otterburn Park,Paspébiac,Percé,Pincourt,Pointe-Claire,Pont-Rouge,Port-Cartier,Portneuf,Prevost,Rimouski,Rivière-du-Loup,Roberval,Salaberry-de-Valleyfield,Sainte-Adele,Sainte-Anne-des-Monts,Sainte-Marie,Sainte-Thérèse,Sorel-Tracy,Stanstead,Sutton,Thetford Mines,Varennes,Westmount,Windsor,Bonaventure,Cap-Chat,Cookshire,Disraeli,Dorval,Richelieu,Saint-Lin-Laurentides,Senneterre,Valcourt,Yamaska,Drummondville,Victoriaville,Beauceville,Boucherville,Cowansville,Forestville,Kingsey Falls,Louiseville,Murdochville,Lennoxville,Plessisville,Schefferville",
    "status": "COMPLETE"
  },
  {
    "name": "Chipilo",
  ...
  },
  {
    ...
    "d": "lnrm",
    "m": 0.36,
    "b": "Ottawa,Orléans,Sudbury,Timmins,Pembroke,Hawkesbury,Plantagenet,Casselman,Embrun,Rockland,Cornwall,Alexandria,Vankleek Hill,Clarence-Rockland,Russell,Glengarry,Prescott,Alfred,Alfred and Plantagenet,Bourget,Champlain,Cochrane,Cumberland,Earlton,Hammond,Hearst,Kapuskasing,Kenora,L'Orignal,Mattawa,Morrisburg,New Liskeard,North Dundas,North Glengarry,North Grenville,North Stormont,Sault Ste. Marie,South Glengarry,South Stormont,St. Isidore,Temiskaming Shores,Vanier,Thunder Bay,North Bay,Iroquois Falls,Sturgeon Falls",
    "status": "COMPLETE"
  },
  {
  ...
  },
  {
    ...
    "d": "",
    "m": 0.18,
    "b": "San Mateo Ixtatan,San Sebastian Coatan,Nenton,Yalanhuitz,Yulchen,Chequenalito,Yichcakchin,Bella Linda Frontera,El Platanal,San Luis Villa Real,La Pimienta,Varsovia,Ixquisis,Yolomte,El Pojom,Ixcantzan,Ixhuitz,Besaber,Yalambolop,Ichtzulubum,Ixcana,El Matasano,Yalwitzac,Tinajab,Chaper,Yoljul,Yolhuitzon,Poy,Hiss,Ixquebaj,Quiquilum,Yolaxito,Tzununcap,Chenen,Namtetac,Quecna,Biltac,Ticolal,Bolontaj,Jolomtenam,Yalancamposanto,Yichucun,Taaj,Xoncol,Calhuitz,Jolombojop,Lolbatzam,Yoxacla,Tiqueen,Joom,Cajbaquil,Sactenam,Santo Domingo Xeen,Ulna,Yalanculuz,Aguacate,Bili,Cajtavi,Canquitic,Salamay,Quixal,Subajasum,Yalambojoch,Yuxquen,Chacaj,Jom Tzala,Palegua,Patictenam,Pocobastic,Tzojbal,Xoxctac",
    "status": "COMPLETE"
  },
  {
    "name": "Seri",
  ...
  },
  {
    ...
    "d": "jkmnstw'",
    "m": 0.15,
    "b": "Jocotan,Camotan,Olopa,San Juan Ermita,Chinam Murak,Nenoja,Tontoles,Caparja,Torja,Tansha,Tunuco,Tuticopote,Roblarcito,Agua Blanca,Tituque,El Guayabo,Quetzaltepeque,La Union,Chonco,Colon Jubuco,San Rafael,Tapescos,Carrizalon,La Laguna,Santa Rita,Antigua Ocotepeque,Nueva Ocotepeque,Sensenti,Copan Ruinas",
    "status": "COMPLETE"
  },
  {
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0.1,
    "b": "Ajantequedo,Amuwey,Casilepe,Chipaja,Chuwiluetai,Colwey,Cuap wey,Htim,Hwanuk,Isichaa,Ja-il,Janielja,Jankilawa,Jaweyspa,Jeji chuwilu,Jejija,Jeljumkwinep,Jewiluja wey,Kay kesiay,Kay sipukwin,Konuko,Kumwalo-wakusepol,Kwalwiiy,Kwtuulkhwapu,Matiypuq,Mejewey,Miltija,Mnwiycwilu,Mttaywiiy,Muwa wey,Nyaaywii,Phuwlqhaw,Qhaayxri,Selewalo,Tesil,Wiiyyuwl,Wiyaaypxyaru,Wiiykwsqhalp,Xaxlmuwp,Xaxaycwilu,Xsirxltap,Xwiiyspa,Wiiynyaay,Wiiyxwaaq",
    "status": "COMPLETE"
  },
  {
    "name": "Quechan",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Yuma,Fort Yuma,Winterhaven,Bard,Somerton,Gadsden,Roll,Wellton,Dateland,Palomas,Quartzsite,Blythe,Cibola,Ripley,Aquemche,Tonaya,Yumaya,Amakhwaiya,Kwatsaan,Westmorland,Coolidge Springs,Heber,Holtville,Brawley,Seeley,Imperial,Ocotillo,Coyote Wells,Salton Slough,Moortown,Mesquite,Seneca",
    "status": "COMPLETE"
  },
  {
    "name": "Cochimí",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "San Borja,Santa Gertrudis,Loreto,Mulege,Comondu,Caduano,Calamujue,San Javier,San Juan Londo,Santa Rosalia,San Ignacio,Guadalupe,Santo Domingo,La Purisima,San Jose de Comondu,San Luis Gonzaga,Kadakaamang,Cajalchimin,Cathemeneol,Cuivuco,Hualimea,Vabacahel,Velicata,Vigge,Afegua,Aggavaccaamans,Ajavaiamin,Amaniini,Avolabac,Biaundo,San Francisco Javier,San Francisco Xavier de Vigge-Biaundo,Mision San Ignacio,Mision Santa Gertrudis,Mision Mulege",
    "status": "COMPLETE"
  },
  {
    "name": "Yavapai",
  ...
  },
  {
    ...
    "d": "ahiknorswty':",
    "m": 0.62,
    "b": "Kahnawà:ke,Kanehsatà:ke,Ahkwesáhsne,Kawehnò:ke,Kaná:takon,Tsi Snaíhne,Kenhtè:ke,Wáhta,Oshwé:ken,Kanièn:ke,Kana'tsioharè:ke,Tioweró:ton,Ossernenon,Andagaron,Tionontoguen,Kanagaro,Nowadaga,Tyondaroge,Asserue,Osquake,Canowaroghere,Schanidisse,Caughnawaga,Onekagoncka,Canajoharie",
    "status": "COMPLETE"
  },
  {
    "name": "Cayuga",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0.2,
    "b": "Canawaugus,Salamanca,Genesee Castle,Irving,Gowanda,Cattaraugus,Cold Spring,Steamburg,Shongo,Jimerson Town,Highbanks,Red House,Tonawanda,Oil Springs,Ganondagan,Chenussio,Catherine's Town,Kill Buck,Quaker Bridge,Caneadea,Kanaghsaws,Gathtsegwarohare,Deonundagae,Totiakton,Skoiyase,Sonojowauga",
    "status": "COMPLETE"
  },
  {
    "name": "Tuscarora",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0.1,
    "b": "Atka,Adak,Attu,Akutan,False Pass,King Cove,Nikolski,St. George,St. Paul,Biorka,Kashega,Makushin,Agattu,Kiska,Amak,Amaknak,Auginak,Avatanak,Belkofski,Chernofski,Eider,Iliuliuk,Kashiga,Korovinski,Mashik,Nazan,Sisaguk,Takamitka,Tigalda,Totchikala,Tulik,Ugamitzi,Umnak,Unalga,Unimak,Veselofski,Nikolskoye,Bering Island,Unalaska,Cold Bay,Sand Point",
    "status": "COMPLETE"
  },
  {
    "name": "Quebec French",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Tila,Tumbala,Sabanilla,Salto de Agua,Bachajon,Chilon,Yajalon,Ocosingo,Palenque,Vicente Guerrero,Libertad,San Jeronimo,Santa Rosa,San Miguel,El Rosario,Nueva Palestina,El Triunfo,Chulumani,Limar,Misija,El Sibal,Chila,El Calvario,Limár,Chabon,Choltenango",
    "status": "COMPLETE"
  },
  {
    "name": "Cahuilla",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Tantoyuca,Chicontepec de Tejeda,Tempoal,Tantima,Amatlan,Ixcatepec,Chila,Platon Sanchez,Tepetzintla,Chalma,Chiconamel,Ilamatlan,Zontecomatlan,Texcatepec,Tlachichilco,Ixhuatlan de Madero,Huayacocotla,Zozocolco,Espinal,Papantla,Poza Rica,Tihuatlan,Alamo,Naranjos,Tamiahua,Tuxpan,Cerro Azul,Cazones,Panuco,Ozuluama,Chontla,Citlaltepetl,Tamalin,Chinampa,El Higo,Naranjos Amatlan,Pueblo Viejo,Tampico Alto,Ozuluama de Mascareñas",
    "status": "COMPLETE"
  },
  {
    ...
    "d": "lnrt",
    "m": 0.92,
    "b": "Oaxaca de Juarez,Santa Cruz Xoxocotlan,San Antonio de la Cal,San Bartolo Coyotepec,San Juan Bautista Tlacoatzintepec,San Juan Chilateca,San Lorenzo Cacaotepec,San Miguel del Valle,San Pablo Etla,San Pedro Ixtlahuaca,San Andres Zautla,San Andres Huayapan,Santo Tomas Mazaltepec,Santiago Etla,Santa Lucia del Camino,Santa Maria Atzompa,Santa Maria Coyotepec,Santa Maria El Tule,Santa Maria Guelace,Santa Maria la Rinconada,Teotitlan del Valle,Tlacolula de Matamoros,Trinidad Zaachila,Zapotitlan Palmas,Magdalena Apasco,Magdalena Ocotlan,Natividad,Nazareno Etla,Reyes Etla,San Agustin Yatareni,San Agustin de las Juntas,San Bartolome Quialana,San Dionisio Ocotepec,San Francisco Lachigolo,San Jeronimo Taviche,San Jose del Progreso,San Juan Guelavia,San Lorenzo Albarradas,San Lucas Karakamichi,San Marcos Tlapazola,San Martin Tilcajete,San Miguel Peras,San Miguel Tlacotepec,San Pablo Huitzo,San Pedro Apóstol,San Pedro Martir,San Pedro Molinos,San Raymundo Jalpan,San Sebastian Abasolo,Santa Ana Tlapacoyan,Santa Ana Zegache,Santa Catarina Quioquitani,Santa Gertrudis,Santa Ines Yatzeche,Santiago Apostol,Santiago Matatlan,Santo Domingo Albarradas,Santo Domingo Tomaltepec,Santo Domingo Yanhuitlan,Santos Reyes Yucunama",
    "status": "COMPLETE"
  },
  {
    "name": "Mazatec",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0.9,
    "b": "San Juan Bautista Tuxtepec,Valle Nacional,San Felipe Usila,Santiago Choapam,Santa Maria Chilchotla,San Andres Tenejapa,San Andres Teotilalpam,San Antonio Eloxochitlan,San Bartolome Ayautla,San Carlos Yautepec,San Francisco Chapulapa,San Francisco Huehuetlan,San Juan Bautista Cuicatlan,San Juan Bautista Valle Nacional,San Lucas Ojitlan,San Miguel Soyaltepec,San Pedro Ixcatlan,San Pedro Pochutla,Santa Ana Ateixtlahuaca,Santa Cruz Acatepec,Santa Cruz Amilpas,Santa Maria Tecomavaca,Santa Maria Yolotepec,Santiago Comaltepec,Santiago Ihuitlan Plumas,Santiago Jocotepec,Santiago Matatlan,Santo Domingo Teojomulco,Santo Tomas Ocotepec,Villa Tejupam de la Union,San Andres Yaa,San Juan Yatzona,San Pablo Yaganiza",
    "status": "COMPLETE"
  },
  {
    "name": "Chinook Jargon",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0.9,
    "b": "Juchitan de Zaragoza,Tehuantepec,Salina Cruz,Matias Romero Avendaño,San Blas Atempa,Santa Maria Xadani,Santo Domingo Petapa,Santo Domingo Ingenio,San Juan Guichicovi,Santa Lucia del Camino,San Francisco Ixhuatan,San Dionisio del Mar,Santiago Astata,Santa Maria del Mar,San Pedro Huilotepec,El Espinal,Ixtaltepec,Asuncion Ixtaltepec,San Miguel Tenango,Santo Domingo Tehuantepec,Magdalena Tlacotepec,Santa Rosa de Lima,Union Hidalgo,San Mateo del Mar,San Francisco del Mar,Santiago Laollaga,Loma Bonita,Cosolapa,Rio Grande,Jesus Carranza,Donají,Santa Maria Petapa,Chahuites,Ciudad Ixtepec,La Ventosa",
    "status": "COMPLETE"
  },
  {
    "name": "Itza",
  ...
  },
  {
    ...
    "d": "",
    "m": 0.28,
    "b": "Waskaganish,Chisasibi,Mistissini,Ouje-Bougoumou,Waswanipi,Nemiscau,Eastmain,Wemindji,Whapmagoostui,Nemaska,Lac La Biche,Beaver Lake,Heart Lake,Onion Lake,Saddle Lake,Cold Lake,Frog Lake,Buffalo Lake,Sandy Lake,Big River,Montreal Lake,La Ronge,Stanley Mission,Black Lake,Fond du Lac,Stony Rapids,Beardy's,Okemasis,Muskeg Lake,Sweetgrass,Poundmaker,Little Pine,Moosomin,Cowessess,Ochapowace,Cote,Keeseekoose,The Pas,Opaskwayak,Moose Factory,Attawapiskat,Kashechewan,Fort Albany,Fort Severn,Peawanuck,Wabasca,Hobbema,Samson,Enoch,Alexis,Paul,Sturgeon Lake,Duncan's,Driftpile,Kapawe'no,Swan River,Chemawawin,Mathias Colomb,Nelson House,Norway House,Grand Rapids,Shoal Lake,Pelican Lake,Red Pheasant,Battleford,Thunderchild,Witchekan,Mistawasis,Ahtahkakoop,Muscowpetung",
    "status": "COMPLETE"
  },
  {
    "name": "Ojibwe",
  ...
  },
  {
    ...
    "d": "kk",
    "m": 0.18,
    "b": "Bethel,Akiachak,Akiak,Atmautluak,Eek,Goodnews Bay,Upper Kalskag,Lower Kalskag,Kipnuk,Kongiganak,Kwethluk,Kwigillingok,Napakiak,Napaskiak,Nunapitchuk,Oscarville,Platinum,Quinhagak,Tuluksak,Tuntutuliak,Aleknagik,Clarks Point,Dillingham,Manokotak,Togiak,Twin Hills,Alakanuk,Emmonak,Holy Cross,Marshall,Mountain Village,Nunam Iqua,Pilot Station,Pitkas Point,Russian Mission,St. Marys,Scammon Bay,Aniak,Chuathbaluk,Crooked Creek,McGrath,Sleetmute,Stony River,Egegik,Igiugig,Iliamna,Kokhanok,Levelock,Naknek,South Naknek,Chefornak,Newtok,Nightmute,Stebbins,Toksook Bay,Tununak,Ekwok,Koliganek,New Stuyahok,Portage Creek,Hooper Bay,Chevak,Mekoryuk",
    "status": "COMPLETE"
  },
  {
    "name": "Cherokee",
    ...
    "d": "lnrt",
    "m": 0.28,
    "b": "Tahlequah,Qualla,Oconaluftee,Tuckaseegee,Nantahala,Cullowhee,Birdtown,Big Cove,Snowbird,Tanasi,Chota,Citico,Toqua,Tomotley,Tuskegee,Chilhowee,Tallassee,Mialoquo,Great Tellico,Tellico,Nickajack,Running Water,Keowee,Etowah,Ellijay,Tugaloo,Chattooga,Coosawatee,New Echota,Red Clay,Sautee,Nacoochee,Watauga,Nolichucky,Conasauga,Tallulah,Unicoi,Sequatchie,Ocoee,Santeetlah,Brasstown,Salacoa,Cheowa,Tla'nuwa,Atla'nuwa,Tuckalegee,Ugun'yi,Dulu'si,Kettooah,Ketoowah,Tsunda ni ti yi,Na Yu' H Ge Yun' I,Ela i-tse-yi,Nv-ya Gv-wo-ni-sgi,Gv'wo-ni-sgi,Di Yv'ne,Yv'ne,Tsiya-Hi,Tsiya,Yunwi,Ani'-Wa'di,Ani'-Yun-WeYa,Tsalagi,Tsatanu'gi,Kituwah,Cowee,Nikwasi,Hiwassee,Chatuga,Willstown,Turkeytown,Toxaway,Tsiya-Gi,Gadugi",
    "status": "COMPLETE"
  },
  {
    "name": "Apache",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Mentasta,Tetlin,Gakona,Chistochina,Gulkana,Willow Creek,Cantwell,Talkeetna,Sutton,Chickaloon,Tazlina,Klutina,Tonsina,Chitina,Nabesna,Slana,Copper Center,Glennallen,Tyonek,Eklutna,Nikiski,Kenai,Nondalton,Iliamna,Beluga,Nanwalek",
    "status": "COMPLETE"
  },
  {
    "name": "Qeqchi",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 2,
    "b": "Mérida,Valladolid,Tizimín,Ticul,Oxkutzcab,Tekax,Peto,Chemax,Temozon,Espita,Sinanché,Motul,Muna,Maní,Sacalum,Halachó,Maxcanú,Campeche,Hecelchakán,Calkiní,Champotón,Escárcega,Calakmul,Candelaria,Palizada,Tenosique,Balancán,Jonuta,Ciudad del Carmen,Sabancuy,Umán,Hoctún,Tecoh,Ucú,Yaxkukul,Kinchil,Hocabá,Izamal,Xpujil,Felipe Carrillo Puerto,Bacalar,Cozumel,Lázaro Cárdenas (Quintana Roo)",
    "status": "COMPLETE"
  },
  {
    "name": "Totonac",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Papantla,Pantepec,Coyutla,Coahuitlan,Zozocolco,Tecolutla,Gutierrez Zamora,Coxquihui,Mecatlan,Filomeno Mata,Amatlan,Atzalan,Juchique,Tehuipango,Tlapacoyan,Chumatlan,Espinal,Coatepec,Cosautlan,Cotaxtla,Colipa,Chiconquiaco,Fortin,Huatusco,Ixhuacan,Ixhuatlan,Ixhuatlancillo,Jalacingo,Jalcomulco,Jilotepec,Las Minas,Las Vigas,Miahuatlan,Minatitlan,Misantla,Naolinco,Nautla,Nogales,Oluta,Omealca,Orizaba,Otatitlan,Paso del Macho,Paso de Ovejas,Perote,Platon Sanchez,Playa Vicente,Puente Nacional,Rafael Delgado,Rio Blanco,San Andres Tuxtla,Santiago Tuxtla,Sayula de Aleman,Soconusco,Soteapan,Tatahuicapan,Texistepec,Tezonapa,Tierra Blanca,Tihuatlan,Tlacojalpan,Tlacolulan,Tlacotalpan,Tlaltetela,Tlaquilpa,Tlilapan,Tomatlan,Tonayan,Totutla,Tres Valles,Vega de Alatorre,Veracruz,Villa Aldama,Xalapa,Xico,Xoxocotla,Yanga,Yecuatla,Zacualpan,Zongolica,Zontecomatlan",
    "status": "COMPLETE"
  },
  {
    "name": "Qanjobal",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Angoon,Hoonah,Kake,Pelican,Sitka,Elfin Cove,Gustavus,Klukwan,Skagway,Haines,Juneau,Kodiak,Metlakatla,Cordova,Kasaan,Hydaburg,Klawock,Craig,Ketchikan,Saxman,Wrangell,Petersburg,Wales,Tenakee Springs,Douglas,St Michael,Kaltag,Huslia,Rampart,Aastead",
    "status": "COMPLETE"
  },
  {
    "name": "Salish",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Vancouver,Victoria,Seattle,Portland,Bellingham,Olympia,Tacoma,Yakima,Spokane,Kalispell,Missoula,Flathead Lake,Kamloops,Kelowna,Penticton,Nelson,Castlegar,Trail,Cranbrook,Fernie,Lillooet,Merritt,Hope,Chilliwack,Mission,New Westminster,Surrey,Delta,Richmond,Nanaimo,Comox,Courtenay,Port Alberni,Tofino,Ucluelet,Parksville,Duncan,Sidney,Sooke,Bamfield,Ahousaht,Hot Springs Cove,Zeballos,Tahsis,Gold River,Campbell River,Sayward,Woss,Port McNeill,Port Hardy,Sointula,Bella Bella,Bella Coola,Klemtu,Kitimat,Terrace,Prince Rupert,Maple Ridge,Qualicum Beach,Alert Bay,Hartley Bay,Sechelt",
    "status": "COMPLETE"
  },
  {
    "name": "Innu",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Tlapa de Comonfort,La Montana,Atlamajalcingo del Monte,Acatepec,Alpoyeca,Xalpatlahuac,Huamuxtitlan,Tlapa,Malinaltepec,Metlatonoc,Zapotitlan Tablas,Tlacotepec,San Nicolas,Copalillo,Olinala,Ahuacuotzingo,Chilapa de Alvarez,Jose Joaquin de Herrera,Quechultenango,Mochitlan,Tixtla de Guerrero,Tepecoacuilco de Trujano,Huitzuco de los Figueroa,Iguala de la Independencia,Copanatoyac,Xochihuehuetlan,Cualac,Cuetlapa,Pilcaya,Ixcateopan de Cuauhtemoc,Taxco de Alarcon,Buenavista de Cuellar,Tetipac",
    "status": "COMPLETE"
  },
  {
    "name": "Paipai",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Santa Catarina,San Isidoro,El Alamo,Valle de la Trinidad,Rincon de Santa Catarina,Sauce Largo,Sauce Solo,Yokakiul,El Pinacate,Arroyo de Leon,Camalu,Canon de la Parra,El Sauzal,Mision Santo Domingo,Real del Castillo Nuevo,Puerta Trampa,San Belem,Rancho Escondido,Rancho Mariscal,Rancho San Belem,Rancho Santa Martha,Rancho las Canoas,Rancho Agua de Vida,Rancho el Sauco,Porticos del Mar,Poblado Heroes de Chapultepec,Ojo de Agua Colorada,Ex Hacienda Sinaloa,El Aguajito,El Alamar,La Huerta,La Vinata,Leyes de Reforma",
    "status": "COMPLETE"
  },
  {
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Huimanguillo,Cardenas,Comalcalco,Cunduacan,Paraiso,Jalpa de Mendez,Nacajuca,Centla,Jonuta,Macuspana,Teapa,Tacotalpa,Tenosique,Balancan,Emiliano Zapata,Ayapa,Olcuatitan,Esquipulas,Tapijulapa,Oxolotan,Amatan,Solosuchiapa,Ixhuatan,Pichucalco,Tecpatan,Copainala,Mezcalapa,Raudales,Ostuacan",
    "status": "COMPLETE"
  },
  {
    "name": "Chochotec",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Koyukuk,Galena,Nulato,Huslia,Hughes,Allakaket,Bettles,Evansville,Alatna,Tanana,Ruby,Rampart,Stevens Village,Circle,Fort Yukon,Voznesenka,Kaltag,Andreafsky,Anvik,Grayling,Holy Cross,Russian Mission,Marshall,Pitkas Point,Alakanuk",
    "status": "COMPLETE"
  },
  {
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Miccosukee,Immokalee,Ahfachokee,Ochopee,Clewiston,Pahokee,Belle Glade,Chokoloskee,Big Cypress,Tamiami Trail,Miccosukee Reservation,Big Cypress Reservation,Hollywood Reservation,Brighton Reservation,Everglades,Okaloacoochee Slough,Loxahatchee,Shark River,Ten Thousand Islands,Big Cypress Swamp,Apalachicola,Oconee,Sawokli,Chiaha,Okmulgee,Alachua,Okahumka,Okeechobee,Apalachee,Tallahassee,Withlacoochee,Alafia,Suwannee,Chipola,Aucilla,Wakulla,St. Marks,Caloosahatchee,Peke,Immokalee Reservation,Miccosukee Service Area,Billie Swamp,Loop Road,Alligator Alley,Fisheating Creek,Mangrove,Apalachicola Bay,Brighton,Hollywood,Tamiami,Indiantown",
    "status": "COMPLETE"
  },
  {
    "name": "Comanche",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Tuba City,Moenave,Hotevilla,Bacavi,Old Oraibi,Third Mesa,Oraibi,New Oraibi,Mishongnovi,Shungopavi,Sitsomovi,First Mesa,Walpi,Hano,Tewa Village,Polacca,Moenkopi,Keams Canyon,Winslow,Holbrook,Second Mesa,Sichomovi,Kykotsmovi,Sipaulovi,Lower Moenkopi",
    "status": "COMPLETE"
  },
  {
    "name": "Shoshoni",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Wells,Elko,Lamoille,North Fork,Tuscarora,Mountain City,Jackpot,Owyhee,Mountain Home,Idaho,Nevada,Utah,Wyoming,Fort Hall,Shoshone-Bannock,Duck Valley,Fort McDermitt,Pyramid Lake,Walker River,Fallon,Lovelock,Winnemucca,Battle Mountain,Ely,Spring Creek,Duckwater",
    "status": "COMPLETE"
  },
  {
    "name": "Kalaallisut",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Nuuk,Sisimiut,Ilulissat,Qaqortoq,Maniitsoq,Tasiilaq,Uummannaq,Narsaq,Paamiut,Nanortalik,Upernavik,Qasigiannguit,Qeqertarsuaq,Qaanaaq,Kangaatsiaq,Kullorsuaq,Kangerlussuaq,Ittoqqortoormiit,Kangaamiut,Tasiusaq,Saattut,Kuummiit,Ikerasak,Kulusuk,Niaqornaarsuk,Itilleq,Tiilerilaaq,Qeqertaq,Sarfannguit,Ikerasaarsuk,Aappilattoq,Ikamiut,Arsuk,Qassiarsuk,Eqalugaarsuit,Napasoq,Iginniarfik,Ilimanaq,Narsarmijit,Akunnaaq,Kitsissuarsuit,Kapisillit,Isertoq,Savissivik,Naajaat,Oqaatsut,Nutaarmiut,Siorapaluk,Igaliku,Ammassivik,Niaqornat,Saarloq,Qeqertat",
    "status": "COMPLETE"
  },
  {
    "name": "Chontal Maya",
  ...
  },
  {
    ...
    "d": "",
    "m": 0,
    "b": "Nebaj,Chajul,Cotzal,Santa Avelina,Acul,La Perla,Salquil,Chel,Xexuc,Juil,Nebaj Centro,Chajul Centro,San Juan Cotzal,Santa María Nebaj,Visguí,Ilom,Tzalbal,Tzunun,Cachim,Río Azul,Xacxac,Bichil,Chacenta,Sumal,Cotzal Viejo,La Laguna,Xolhuitz",
    "status": "COMPLETE"
  },
  {
    "name": "Jakaltek",
  ...
  },
  {
    ...
    "d": "",
    "m": 0.62,
    "b": "Todos Santos Cuchumatán,San Juan Atitán,Colotenango,San Pedro Necta,San Gaspar Ixchil,San Rafael Petzal,Santa Bárbara,La Libertad,La Democracia,San Ildefonso Ixtahuacán,Santiago Chimaltenango,Tectitán,San Sebastián Huehuetenango,Concepción Tutuapa,Tacaná,Tajumulco,Tejutla,San Marcos,Comitancillo,San Miguel Ixtahuacán,Cajolá,San Miguel Sigüilá,San Juan Ostuncalco,Concepción Chiquirichapa,San Martín Sacatepéquez,Huitán,Colomba,Flores Costa Cuca,Génova,Palestina de los Altos,Cabricán,Xinab'ajul,Txolja'",
    "status": "COMPLETE"
  },
  {
    "name": "Poqomam",
  ...
  },
  {
    ...
    "d": "",
    "m": 0.1,
    "b": "San Cristobal Verapaz,Tactic,Tamahu,Tucuru,Santa Cruz Verapaz,San Juan Chamelco,Panzos,Senahu,Cahabon,Chisec,Raxruha,Lanquin,San Pedro Carcha,Coban,Salama,Purulha,San Agustin Acasaguastlan,El Estor,Semococh,Guabito,Rio Hondo,La Tinta,Santa Maria Cahabon,Cahabon Viejo,Las Vacas",
    "status": "COMPLETE"
  },
  {
    "name": "Tz'utujil",
    ...
    "d": "",
    "m": 0.1,
    "b": "Santiago Atitlan,San Pedro La Laguna,San Juan La Laguna,San Marcos La Laguna,Santa Cruz La Laguna,Solola,Panajachel,Santa Maria Visitacion,San Andres Semetabaj,San Antonio Palopo,San Lucas Toliman,Santa Catarina Palopo,San Jose Chacaya,Patulul,San Buenaventura,San Jorge La Laguna,Cerro de Oro,Chacaya,Concepcion,Santa Clara,El Triunfo,Las Trampas,La Cumbre,Panyebar,Pamame,Chuitinamit,Tzanchaj,Tzununa,Jaibalito",
    "status": "COMPLETE"
  },
  {
    "name": "Sakapultek",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0.15,
    "b": "Navojoa,Huatabampo,Etchojoa,Alamos,Quiriego,Rosario,San Ignacio Rio Muerto,El Jupare,Camahuiroa,Masiaca,San Jose de Gracia,Buaysiacobe,Cohuirimpo,Conicari,Bacabachi,Tehuivo,Cocorit,Bacum,Cajeme,Empalme,Guaymas,Benito Juarez,General Plutarco Elias Calles,San Miguel de Horcasitas,Hermosillo,Ciudad Obregon,Navojoa Pueblo,El Fuerte,Choix",
    "status": "COMPLETE"
  },
  {
    "name": "O'odham",
    ...
    "d": "lnrt",
    "m": 0.1,
    "b": "Sells,Topawa,Gu Vo,Chukson,Ali Chuk,Ali Chukson,Hickiwan,Pisinemo,Josefa,Komakwuik,San Xavier del Bac,Gila Bend,Maricopa,Ak Chin,Sacaton,Casa Blanca,Cowlic,Fresnal,San Simon,Santa Rosa,Vamori,Kohatk,Maish Vaya,Ventana,Quijotoa,Big Fields,Little Fields,Anegam,Toliacho,Koak",
    "status": "COMPLETE"
  },
  {
    "name": "Pima Bajo",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Yepachic,Maycoba,Yecora,Oquitoa,Atil,Cucurpe,Tubac,Tumacacori,Catalina,Naco,Sasabe,Magdalena,Imuris,Santa Cruz,Altar,Caborca,Saric,Pitiquito,Trincheras,Moros,Quiriego,San Bernardino,La Colorada,San Miguel de Horozas,Desemboque,Alamos,Navojoa",
    "status": "COMPLETE"
  },
  {
    "name": "Tarahumara",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Creel,Batopilas,Guachochi,Norogachi,Temosachi,Cusihuiriachi,Urique,Chinipas,Guazapares,Morelia,Uruachi,Maguarichi,Tepahuis,Chicar,Nonoava,Bocoyna,San Rafael,Ocampo,Temosachic,Carichi,San Juanito,Samachique,Parral,Jimenez,Camargo",
    "status": "COMPLETE"
  },
  {
    "name": "Huarijio",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Alamos,Uruachi,Chinipas,Maguarichi,Guazapares,Morelia,Tepahuis,Chicar,Nonoava,Ocampo,Guachochi,Temosachic,Carichi,Cusihuiriachi,Urique,Batopilas,Creel,Norogachi,Temosachi,San Juanito,Samachique,Chinipas de Almada,Moris,Quiriego,Rosario",
    "status": "COMPLETE"
  },
  {
    "name": "Yaqui",
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Guaymas,San Carlos,Bahia Kino,Puerto Lobos,Punta Tepopa,Cocorit,Loma de Bacum,Loma de Guamuchil,Potam,San Pedro de la Cueva,Huatabampo,Navojoa,Vicam,Rahum,Torim,Huirivis,Belem,Alamos,Hant Ihiin,Heeno,Xnaamotat,Xiica hast ano,Tahejoc himquij,Cofteecol hipcap,Socaaix hac",
    "status": "COMPLETE"
  },
  {
    "name": "Iñupiaq",
    ...
    "d": "lnrtk",
    "m": 0.08,
    "b": "Utqiaġvik,Wainwright,Tikiġaq,Point Lay,Kivalina,Atqasuk,Anaktuvuk Pass,Unalakleet,St. Michael,Golovin,White Mountain,Elim,Koyuk,Teller,Brevig Mission,Shishmaref,Kobuk,Noorvik,Buckland,Deering,Ambler,Noatak,Selawik,Shungnak,Kaktovik,Nuiqsut,Kiana,Wales,Kotzebue",
    "status": "COMPLETE"
  },
  {
    "name": "Inuvialuktun",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Siksika,Stand Off,Brocket,Cardston,Glenwood,Mountain View,Pincher Creek,Fort Macleod,Lethbridge,Cluny,Gleichen,Abbey,Carmangay,Champion,Lomond,Milo,Mossleigh,Nanton,Stavely,Vulcan,Arrowwood,Cayley,Herronton,Brant,Coutts,Magrath,Raymond,Stirling,Warner,Blood 148,Peigan 147",
    "status": "COMPLETE"
  },
  {
    "name": "Haida",
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Acoma,Laguna,Cochiti,Santo Domingo,San Felipe,Santa Ana,Zia,Sia,Paguate,Acomita,Moquino,Pueblito,Heashkowa,Kakanatzia,Kohasaya,Kowina,Kuchtya,Tapitsiama,Tsiama,Wapuchuseamma,Yapashi,Cieneguilla,Cubero,Hasatch,Punvekia,Punyeestye,Pusityitcho,Seemunah,Siama,Paraje,Encinal,Mesita",
    "status": "COMPLETE"
  },
  {
  ...
  },
{
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "San Mateo del Mar,San Dionisio del Mar,San Francisco del Mar,Santa Maria del Mar,Guazontlan,Ocelotlan,Tepeguazontlan,Ixtaltepec del Mar,Salina Cruz,Puerto Salina,Cerro Bernal,Cerro Cristo,La Venta,La Ventosa,Santo Domingo Chihuitan,Santa Maria Xadani,San Antonio,Santiago Astata,Juchitan de Zaragoza,Istmo de Tehuantepec,Golfo de Tehuantepec,Laguna Superior,Laguna Inferior,Mar Muerto,Estero del Mar,La Arenca,El Potrero,La Huerta,Los Cocos,El Tamarindo,La Poza,El Llano,La Ceiba,El Naranjo,El Porvenir,La Cruz,El Zapote,La Esperanza,San Miguel,El Rosario",
    "status": "COMPLETE"
  },
  {
    "name": "Joual",
