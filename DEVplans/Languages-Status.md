...
- ✅ **2025-12-21 (PAPUAN_INTEGRATION / worker-cascade):** Integrated a fourth batch of Papuan languages (7 total) into the Language Mixer system.
    ...
    - **Reachability:** Confirmed reachability for Seafarer, Aarakocra, Triton, Tortle, and Deepkin races via the `Papuan` category in `modules/races.js`.
    - **Verification:** Resolved a stale lock issue in `apply-mixer-deltas.js`; `pnpm run mixer:apply-deltas` OK; seed-uniqueness report OK (all 7 languages strictOK/normOK with 12 unique seeds).
...
- ✅ **2025-12-21 (NO_UNIQ_BASE / worker-cascade):** Resolved dedicated base pins for worker 16 batch 5: `kgk` (13804), `kgp` (13805), `kha` (13806), `kha-lyngngam` (13807), `kha-native-speakers` (13808), `kha-pnar` (13809), `kha-war` (13810), `khakas` (13811), `kham` (13812), `khamnigan` (13813), `khams-tibetan` (13814), `khamti` (13815), `khamyang` (13816), `kharia` (13817), `khm` (13818), `khm-khe` (13819), `khm-northern` (13820), `kho-bwa` (13821), `khori-buryat` (13822), `khortha` (13823). Added dedicated base defs in `modules/namebases-real.js` and updated `config/language-mixer-map.json` via delta `tools/mixer-deltas/2025-12-21-worker16-batch5-uniqueness.json`. Verified via `pnpm run mixer:guardrails` + `report-language-mixer-seed-uniqueness.js` OK (all strictOK/normOK).

- ✅ **2025-12-21 (NO_UNIQ_BASE / worker-cascade):** Resolved dedicated base pins for worker 16 batch 4: `khv` (13739), `khw` (13740), `kiautschou-pidgin-german` (13741), `kichwa` (13742), `kiga` (13743), `kij` (13744), `kikar` (13745), `kikuyu` (13746), `kim-mun` (13747), `kimaama-kimaghama` (13748). Added dedicated base pins via delta `tools/mixer-deltas/2025-12-21-worker16-batch4-uniqueness.json` and updated `config/language-mixer-map.json`. Verified via `pnpm run mixer:guardrails` + `report-language-mixer-seed-uniqueness.js` OK (all strictOK/normOK).
...
- ✅ **2025-12-20 (NO_UNIQ_BASE / worker-cascade):** Resolved dedicated base pins for Batch 17: `kiga` (13743), `kikuyu` (13746), `kinyarwanda` (13749), `kirundi` (13750), `kongo` (13751), `telugu` (13663), `setlokwa` (13664), `shanjo` (13665), `soli` (13666), `suba-simbiti` (13667). Added dedicated base defs in `modules/namebases-real.js` and updated `config/language-mixer-map.json`. Also fixed zero-seed issue for `adeni-arabic` by restoring missing base `i:5106` in `modules/namebases-real.js`. Verified via `node tools/mixer-diagnostics/report-language-mixer-seed-uniqueness.js` OK (all strictOK/normOK with 12-13 unique seeds).

- ✅ **2025-12-20 (NO_UNIQ_BASE / worker-cascade):** Resolved dedicated base pins for batch 16: `dura-tandrange` (13389), `garifuna` (13390), `gla` (13391), `gong` (13392), `gongduk` (13393). Added dedicated base defs in `modules/namebases-real.js` with real place name seeds and created delta `tools/mixer-deltas/2025-12-20-worker16-no-uniq-base-batch1.json`. Verified via `pnpm run mixer:apply-deltas` + `report-language-mixer-seed-uniqueness.js` OK (all strictOK/normOK with 10 unique seeds).
...
- ✅ **2025-12-20 (NO_UNIQ_BASE / worker-cascade):** Resolved dedicated base pins for H-prefix batch: `haflong-hindi` (13082), `hagei` (13083), `hagen` (13084), `haitian-creole` (13085), `haj` (13086), `hakka` (13087), `halang-bahnaric` (13088). Added dedicated base defs in `modules/namebases-real.js` and created delta `tools/mixer-deltas/2025-12-20-h-prefix-batch-setbases.json`. Verified via `pnpm run mixer:apply-deltas` + `report-language-mixer-seed-uniqueness.js` OK (all strictOK/normOK with 13 unique seeds).
...
- ✅ **2025-12-20 (/no-unique-base2 worker6 Chadic/Khmuic/Tibeto-Burman):** Resolved dedicated base pins for Chadic (base 132), Khmuic (base 179), and Tibeto-Burman (bases 47, 48) clusters. Added 13 dedicated base defs `i:13439–13451` in `modules/namebases-real.js` and created delta `tools/mixer-deltas/2025-12-21-worker6-chadic-khmuic-tibeto-burman-uniqueness.json`. ISOs: `proto-ron` (13439), `proto-warji` (13440), `khmu` (13441), `kuy` (13442), `katuic` (13443), `khmuic` (13444), `north-bauchi-languages` (13445), `ron-languages` (13446), `south-bauchi-languages` (13447), `west-chadic-languages` (13448), `proto-tibeto-burman` (13449), `tibeto-burman` (13450), `sal` (13451). Verified: `pnpm run mixer:apply-deltas` OK; `report-language-mixer-base-clusters.js` OK (clusters for 132, 179, [47,48] resolved).
- ✅ **2025-12-21 (/no-unique-base2 worker6 Tamil/Berber):** Resolved dedicated base pins for Tamil (base 199) and Berber (base 17) clusters. Added 17 dedicated base defs `i:13589–13605` in `modules/namebases-real.js` and created delta `tools/mixer-deltas/2025-12-21-worker6-tamil-berber-uniqueness.json`. ISOs: `kolami` (13589), `koraga` (13590), `kota-dravidian` (13591), `kudiya-dravidian` (13592), `kui-dravidian` (13593), `kumbaran` (13594), `paniya` (13595), `pardhan` (13596), `pathiya` (13597), `tidikelt-language` (13598), `tuareg-berber` (13599), `tuareg-languages` (13600), `tuwat-language` (13601), `western-berber` (13602), `western-berber-languages` (13603), `zenaga-language` (13604), `zenati-languages` (13605). Verified: `pnpm run mixer:apply-deltas` OK; `report-language-mixer-base-clusters.js` OK (clusters for 199 and 17 resolved).
- ✅ **2025-12-21 (/no-unique-base2 worker6 Tagalog/Indonesian, Georgian, Inuit):** Resolved dedicated base pins for Tagalog/Indonesian (bases 193/194), Georgian (base 223), and Inuit (base 19) clusters. Added 24 dedicated base defs `i:13639–13662` in `modules/namebases-real.js` and created delta `tools/mixer-deltas/2025-12-21-worker6-austronesian-georgian-inuit-uniqueness.json`. ISOs: `northern-formosan` (13639), `northern-luzon` (13640), `northern-mindoro` (13641), `philippine` (13642), `south-mindanao` (13643), `tsouic` (13644), `greater-central-philippine` (13645), `batanic` (13646), `central-luzon` (13647), `georgian-dialects` (13648), `old-georgian` (13649), `proto-georgian-zan` (13650), `proto-kartvelian` (13651), `zan` (13652), `judaeo-georgian` (13653), `karto-zan` (13654), `kartvelian-languages` (13655), `proto-samoyedic` (13656), `itelmen` (13657), `kamchatkan` (13658), `kerek` (13659), `ket` (13660), `koryak` (13661), `kott` (13662). Verified: `pnpm run mixer:apply-deltas` OK; `report-language-mixer-base-clusters.js` OK (clusters for 193/194, 223, and 19 resolved).
...
- ✅ **2025-12-20 (/no-unique-base2 worker3 haz batch):** Completed `batchId=2025-12-20T09:38:13.175Z-worker3` for `haz, hm-nai, hmn, hmong, hmu, hnd, ho-munda, hoanya, hoj, hoia-hoia` using reserved range `11790–11839`. Added dedicated base defs `i:11790–11799` in `modules/namebases-real.js` and created delta `tools/mixer-deltas/2025-12-20-worker3-batch18.json`. Verified: `pnpm run mixer:apply-deltas` OK; seed-uniqueness OK (strictUniqueSeeds=12-13, normUniqueSeeds=12-13 for all). Fixed typo `hohr` -> `hoj`.
- ✅ **2025-12-20 (/no-unique-base2 worker3 jin batch):** Completed `batchId=2025-12-20T10:54:18.911Z-worker3` for `jin, jingpho, jingpho-luish, jino, jiv, jizhao, jml, jnd, jog, jonkor-language` using reserved range `11840–11889`. Added dedicated base defs `i:11840–11849` in `modules/namebases-real.js` and created delta `tools/mixer-deltas/2025-12-20-worker3-batch19.json`. Verified: `pnpm run mixer:apply-deltas` OK; seed-uniqueness OK (strictUniqueSeeds=13, normUniqueSeeds=13 for all).
...
- **Hausa / Chadic cluster (base 132 as anchor)**:
  ...
  - **2025‑12‑20 major decluster pass:** Successfully declustered the massive Chadic cluster from **105 members** down to **6 acceptable members** (family entries and proto-languages only). Added **90 new dedicated bases** (indices 12020–12110) for individual Chadic languages and assigned unique base combinations featuring each language's dedicated base + Hausa (132) + regional African bases (112 Yoruba, 120 Ewe, 277 Zarma). All individual attested Chadic languages now have unique mixer signatures while maintaining linguistic plausibility.
  - **2025‑12‑20 major decluster pass:** Successfully declustered the Southern Mongolic cluster from **31 members** down to **0 individual language members** (only family entries remain acceptable). Added **28 new dedicated bases** (indices 12140–12167) for individual Mongolic languages and assigned unique base combinations featuring each language's dedicated base + Southern Mongolic (381). All individual attested Southern Mongolic languages now have unique mixer signatures while maintaining regional linguistic coherence.
