...
},
{
  ...
  "d": "",
  "m": 0,
  "b": "CampoGrande,TrêsLagoas,CoraçãoDeMaria,Miranda,Bodoquena,Aquidauana,Anastácio,DoisIrmãosDoBuriti,Sidrolândia,Maracaju,RioBrilhante,NovaAndradina,Bataguasso,Ivinhema,Jateí,NovaAlvoradaDoSul,Paranaíba,Caarapó,Amambai,Dourados,Naviraí,GlóriaDeDourados,Japorã,Itaporã,Deodápolis,Angélica,BelaVista,Carumbeí,RioVerdeDeMatoGrosso,Coxim,Ladário,Corumbá,PontaPorã,GuiaLopesDaLaguna,Nioaque,Figueirão"
},
{
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
    "b": "Panguipulli,Coñaripe,Liquiñe,Neltume,Carirriñe,Futrono,LosLagos,Paillaco,Riñirepu,Trumao,Máfil,Valdivia,Corral,LaUnion,Pullinque,ChoroyTraiguen,Mehuin,SanJoséDeLaMariquina,Rebellin,Cayumapu,IslaTeja,Angol,Victoria,Temuco,Lautaro,Galvarino,Perquenco,NuevaImperial,Carahue,Toltén,Vilcún,Cunco,Melipeuco,Villarrica,Curarrehue,Pucón,Caburgua,Huife"
},
{
    "name": "Cocoliche",
  "i": 9165,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Valdivia,LaUnion,Corral,RíoBueno,Osorno,PuertoMontt,Llanquihue,Frutillar,PuertoVaras,Ancud,Castro,Chonchi,Queilén,Quellón,Melinka,Chaitén,Futaleufú,Palena,Cochamó,Maullín,Calbuco,PuertoOctay,Purranque,SanPablo,SanJuanDeLaCosta,EntreLagos,Puyehue,RíoRico,LosMuermos,Carelmapu"
},
{
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "SãoPaulo,SãoCaetanoDoSantoAndré,SãoBernardoDoCampo,Guarulhos,Santos,Campinas,SãoJoséDosCampos,Sorocaba,RibeirãoPreto,Bauru,Marília,Assis,Ourinhos,Itapetininga,Itapeva,CapãoBonito,Araraquara,SãoCarlos,Jaboticabal,Araras,Limeira,Piracicaba,Americana,SantaBárbaraDOeste,Sumaré,Hortolândia,MonteAlto,Itu,Salto,Jundiaí,VarzeaPaulista,Indaiatuba,Tatuí,Cerquilho,Tietê,LaranjalPaulista,Conchas,Pereiras,Cabreúva,PiraporaDoBomJesus,Itupeva,Jarinu,Itatiba,BragançaPaulista,Atibaia,SerraNegra,Amparo,Jaguariúna,Pedreira,MogiMirim,MogiGuaçu,Pinhalzinho,Socorro,CachoeiraPaulista,Itirapina,SãoPedro,Turuna,Analândia,Descalvado,Leme,Franca,SãoJoséDoRioPreto,Barretos,Catanduva,Votuporanga,Jales,Andradina,PresidentePrudente,Araçatuba,Birigui,Penápolis,Botucatu,SãoManuel,Itapira,Mococa,PousoAlegre,Varginha,PoçosDeCaldas,SãoLourenço,CamposDoJordão"
},
{
    "name": "Kashinawa",
  "i": 13682,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Pucallpa,Contamana,Requena,PuertoMaldonado,Iñapari,Sepahua,Neshuya,Sarayacu,Iparia,Panaillo,Lagunas,Jeberos,SantaRosaDePichan,Chazuta,Loreto,Ucayali,RioBranco,CruzeiroDoSul,Tarauacá,Jordão,Breu,Muru,Envira,Humaitã,Feijó,SenaMadureira,PlácidoDeCastro,Capixaba,Acrelândia,Brasiléia,Epitaciolândia,Xapuri,PortoWalter,AltaFloresta,MâncioLima"
},
{
    "name": "Camsá",
  "i": 13685,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Sibundoy,Santiago,SanAndres,Colon,SanFrancisco,Putumayo,Mocoa,SanVicenteDelCaguán,LaChorrera,ElEncanto,Leticia,PuertoNariño,Tarapaco,SanMartínDeAmacayacu,PuertoSantander,Macedonia,Orito,Guamuez,SanMiguel,LagoAgrio,Aguarico,Napo,Jambelí,Cascales,ElDorado,Cuyabeno,LaBonita,Bermejo,Tablero,ElHacha,NuevaGranada,BuenaVista,PiñaBlanca"
},
{
    "name": "Kichwa",
  "i": 13742,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "FozDoIguaçu,Cascavel,Toledo,MarechalCândidoRondon,Medianeira,Matelândia,LaranjeirasDoSul,SãoMiguelDoIguaçu,FranciscoBeltrão,PatoBranco,DoisVizinhos,SantoAntônioDaPlatina,CampoMourão,Goioerê,CruzeiroDoOeste,NovaAurora,Umuarama,Cianorte,Paranavaí,Loanda,QuerênciaDoNorte,Altamira,NovaLondrina,Arapongas,Apucarina,Maringá,CampoGrande,Dourados,Naviraí,PontaPorã,Amambai,CoronelSapucaia,PortoMurtinho,BelaVista,Caracol,PedroJuanCaballero,Bonito,Aquidauana,Coxim,Ladário,TrêsLagoas,Andradina,PereiraBarreto,Castilho,IlhaSolteira,Tupã,Adamantina,Dracena,Penápolis,Bauru,Jaú,Itapetininga,Lins,Marília,Assis,Ourinhos,PresidentePrudente,Tarumã"
},
{
    "name": "Kaingang",
  "i": 13805,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Barreiras,LuísEduardoMagalhães,SantaMariaDaVitória,SãoDesidério,Jaborandi,Correntina,RiachãoDasNeves,Cristópolis,Cotegipe,Wanderley,Angical,OliveiraDosBrejinhos,Ibotirama,Paratinga,Mansidão,Abaré,Chorrochó,Rodelas,Glória,Itiúba,SítioDoMato,Macururé,Araças,Utinga,Candeias,SãoFélix,Maragogipe,SantoAmaro,Salvador,SimõesFilho,LauroDeFreitas,Camaçari,DiasD'Ávila,MataDeSãoJoão"
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "SãoPaulo,Santos,SãoVicente,Cubatão,Guarujá,PraiaGrande,Mongaguá,Itanhaém,Peruíbe,Bertioga,Caraguatatuba,Ubatuba,Ilhabela,SãoSebastião,Cananéia,Iguape,IlhaComprida,Itacaré,PortoSeguro,SantaCruzCabrália,Alcobaça,Caravelas,Mucuri,PostoDaMata,TeixeiraDeFreitas,VitóriaDaConquista,Itapetinga,Itambé,Itororó,Ituberá,Camamu,Taperoá,NiloPeçanha,Valença,Aratuípe,SantoAntônioDeJesus,Nazaré,Salvador,SimõesFilho,LauroDeFreitas,Camaçari,DiasDÁvila,MataDeSãoJoão,Candeias,SãoFélix,Maragogipe,SantoAmaro,Paranaguá,Antonina,Guaratuba,Curitiba,Londrina,Maringá,PontaGrossa,Guarapuava,Cascavel,FozDoIguaçu,FranciscoBeltrão,PatoBranco,SãoJoséDosPinhais,Colombo,Araucária,Pinhais,TelêmacoBorba,Irati,Prudentópolis,Palmas,DoisVizinhos,SantoAntônioDaPlatina,CampoMourão,Goioerê,CruzeiroDoOeste,NovaAurora,Umuarama,Cianorte,Paranavaí,Loanda,QuerênciaDoNorte,Altamira,NovaLondrina,Arapongas,Apucarina,CampoGrande,Dourados,Naviraí,PontaPorã,Amambai,CoronelSapucaia,PortoMurtinho,BelaVista,Caracol,PedroJuanCaballero,Bonito,Aquidauana,Coxim,Ladário,TrêsLagoas"
},
{
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
    "b": "Tucupita,AntonioDiaz,Nabaruto,Jobure,Guayo,SantaCatalina,SanRafael,Araguabisi,Barranquita,ElTriunfo,LaHorqueta,Macareo,Manacal,Morichalito,Paloma,PasoNuevo,Pedernales,PuntaPedernales,SantaIsabel,Soledad,Tucupido,Voladora,Winikina,Yanamo,Claret,Guiniquina,CañoGuara,BocaGrande,CañoMontero,Cascajal"
},
{
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "ÁguasBelas,Ipanema,Ouricuri,SerraDoCommunati,Carnijó,Carijó,Kariri,Formió,Iatê,Yatê,Garanhuns,Recife,Buíque,Pedra,Iati,Itaíba,Arcoverde,Betânia,SãoJoséDoEgito,Pesqueira,Sanharó,Caetés,Capoeiras,Correntes,ÁguaPreta,Cachoeirinha,Altinho,Panelas,Cupira,Catimbau,BelémDeMaria,JoãoAlfredo,LagoaDoOuro,Paranatama,Saloá,Terezinha,Itapetim,SantaCruzDaBaixaVerde,SãoJoséDoBelo"
},
{
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Pucallpa,Tarapoto,Moyobamba,Jaén,Chiclayo,Piura,Trujillo,Cajamarca,Huancayo,Tumbes,PuertoMaldonado,Quillabamba,NuevaCaamarca,BaguaGrande,Yurimaguas,Requena,Contamana,NuevaRequena,Manantay,Masisea,Yarinacocha,Aguaytía,Tournavista,PuertoIncaa,Shanshococha,SantaClara,Callsao,RamónCastilla,Maquía,Neshuya,Sarayacu,Iparia,Panaillo,Lagunas,Jeberos,SantaRosaDePichan,Chazuta,Loreto,Ucayali,Huánuco,SanMartín,Amazonas,Tahuayo,Nauta,Parinari,VillaTierraBlanca,PampaHermosa"
},
{
    "name": "Kallawaya",
  "i": 21005,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "LaPaz,Oruro,Potosí,ElAlto,Viacha,Llallagua,Huanuni,Challapata,Betanzos,Uncía,Cotagaita,VillaDeSaca,Punata,Cliza,Tapacarí,Arani,Independencia,Totora,PuertoVillarroel,Mizque,Aiquile,Tupiza,Uyuni,SalinasDeGarciMendoza,LagunaColorada,LagunaVerde,SanJuan,SanPedroDeQuemes,ColchaK,VillaDeSacaca"
},
{
    "name": "Chiquitano",
  "i": 21016,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "SantaCruzDeLaSierra,Cochabamba,LaPaz,Oruro,Potosí,Sucre,Tarija,Trinidad,Cobija,Riberalta,Montero,Quillacollo,ElAlto,VillaTunari,Samaipata,Camiri,Roboré,PuertoSuárez,PuertoQuijarro,Tupiza,Uyuni,Llallagua,Huanuni,Challapata,Betanzos,Uncía,Cotagaita,VillaDeSaca,Punata,Cliza,Tapacarí,Arani,Independencia,Totora,PuertoVillarroel,Mizque,Aiquile"
},
{
    "name": "Andoque",
  "i": 201304,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "CampoLoro,Ebetogué,Tunucojnai,Gaai,Esquina,Jesudi,Jogasui,Ijnapui,Arocojnadí,Chaidi,Cucaani,IslaAlta,GuidaiIchai,Tiogai,Punta,Atapi,PalmarDeLasIslas,AguaDulce,Chovoreca,DefensoresDelChaco,MédanosDelChaco,Otuquis,PuertoBahía,PuertoCórdoba,PuertoTriunfo,PuertoLimón,PuertoIndio,Dureno,Zábalo,Sinangué,Dovuno,Villanueva,SantaRosaDeSucumbíos,Yarinal,SanAntonio,BocanasDelLuzón,Diviso,LaRivera,Orito,Guamuez,SanMiguel,LagoAgrio,Aguarico,Napo,Putumayo,Jambelí,Cascales,ElDorado,Cuyabeno,LaBonita,Bermejo,Tablero,ElHacha,NuevaGranada,BuenaVista,PiñaBlanca"
},
{
    "name": "Cofán",
  "i": 201309,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "PuertoAsís,LaHormiga,ElPaujil,ValleDelGuamuez,SanAndres,LaDorada,PuertoColombia,PuertoLeguizamo,Orito,LaTagua,PuertoGuzmán,ElPlacer,PuertoRodríguez,LaFlorida,PuertoCaicedo,Mocoa,Sibundoy,PuertoUmbría,Villagarzón,PuertoLimón,PuertoBolívar,PuertoCórdoba,PuertoTriunfo,PuertoIndio,Dureno,Zábalo,Sinangué,Dovuno,Villanueva,SantaRosaDeSucumbíos,Yarinal,Afilador,BocanasDelLuzón,Diviso,LaRivera,Guamuez,LagoAgrio,Aguarico,Napo,Putumayo,Jambelí,Cascales,ElDorado,Cuyabeno,LaBonita,Bermejo,Tablero,ElHacha,NuevaGranada,BuenaVista,PiñaBlanca"
},
{
    "name": "Cogui",
  "i": 201310,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "SanMiguel,Poteca,Mechinguche,Mamu,Kívgi,Mamarongo,Guatapurí,Nabá,Teykú,Chonchacala,Serankua,Windiwameina,Singunei,Zigta,Yeurwa,Gumuke,Yeiwin,Seyarukwingumu,Buyuaguenka,Simonorwa,Wirwa,Yugaka,Karwa,Sogrome,Donachwi,Timaka,Aruamake,Seinimin,Izrwa,GunAruwun,Ikarwa,Seykunchin,Maestre,AtyBerna,LosLimites,Cañaveral,Ciénaga"
},
{
    "name": "Fulniô",
  "i": 201311,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "SãoGabrielDaCachoeira,Içana,Uaupés,Tiquié,Aiari,Yurupari,Cumati,Aracaçá,PariCachoeira,Cucui,Maturacá,Cabari,Igapo,CaiuryCaiury,Papuri,Yauareté,Taracuá,SãoJoaquim,Campalaú,Caruru,Marabitana,Lauarete,Guariba,Barcelos,SantaIsabelDoRioNegro,Carvoeiro,Paricachoeira,Piraiauara,Yukutaninha,Cauichuari"
},
{
    "name": "Kayapo",
  "i": 201316,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Altamira,SãoFélixDoXingu,OurilândiaDoNorte,Tucumã,Marabá,SantanaDoAraguaia,Redenção,Tucuruí,Pacajá,Iriri,Parauapebas,CanãaDosCarajás,Curionópolis,NovoRepartimento,SãoJoãoDoAraguaia,SantaMariaDasBarreiras,RibeirãoCascalheira,CumaruDoNorte,Itupiranga,RondonDoPará,AbelFigueiredo,BomJesusDoTocantins,SãoGeraldoTocantins,SãoJoãoDoPiauí,SãoMiguelDoAraguaia,SãoSebastiãoDaBoaVista,SenadorJoséPorfírio,Souzel,Tailândia,VilaDoConde"
},
{
    "name": "Kulina",
  "i": 201317,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "PimenteirasDoOeste,Cerejeiras,ColoradoDoOeste,Vilhena,PortoVelho,Ariquemes,JiParaná,RolimDeMoura,AltaFloresta,Jaru,MachadinhoDOeste,NovaMamoré,Buritis,CampoNovo,Corumbiara,Cacaulândia,Theobroma,GovernadorJorgeTeixeira,MinistroAndreazza,Castanheiras,Chupinguaia,PimentaBueno,OuroPretoDoOeste,NovoHorizonteDoOeste,Cacoal,SantaLuziaDOeste,AltoAlegreDosParecis,TouroPreto,PrimaveraDeRondônia,AlvoradaDOeste"
},
{
    "name": "Kwinti",
  "i": 201319,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Mapiri,Atén,SantaAnaDeAltoBeni,Guanay,Turupoa,Tipuani,Apolo,Charazani,Cajuata,Teoponte,PuertoAcosta,Ayata,Cocoma,Pongo,Chivé,Ixiamas,Inquisivi,Cañamina,Combaya,Quiabaya,Ichoca,Cotata,Hucurate,Camata,Calamarca,Ambaná,Coroico,Caranavi,Copacabana,TitoYupanqui,Chulumani,Palca,Pucarani,Irupana,Cairoma"
},
{
    "name": "Matawai",
  "i": 201321,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Jacareacanga,Itaituba,Santarém,Belterra,Rurópia,AltaFloresta,Cururu,TelesPires,Canumã,Uruará,Placas,Rurópolis,Trairão,Aveiro,Itupiranga,Parauapebas,Marabá,Parauá,Aruri,TerraPreta,SãoJosé,Barreira,Tauri,Muiraquita,Prainha,NovaJacareacanga,Caracol,Óbidos,Juruti,Alenquer,Oriximiná,Barcarena"
},
{
    "name": "Ndyuka",
  "i": 201323,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Filadelfia,Mcalister,Neuland,LomaPlata,ColoniaMenno,TenienteIralaFernández,FuerteOlimpo,BenjaminAceval,MariscalEstigarribia,PozoColorado,PresidenciaDeLaSierra,GeneralEugenioAGaray,PedroPPeña,Ingenio,VillaHayes,Marangarú,Independencia,FortínGralDíaz,CapitánBado,JuandeZalazar,PuertoCasado,PuertoPinasco,BahíaNegra,LaVictoria,ColoniaFernheim,ColoniaNeuland,ColoniaMennoSur,ColoniaLomaPlata,ColoniaMennoNorte,ColoniaFernheimNorte"
},
{
    "name": "Páez",
  "i": 201326,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Totoró,Jambaló,Puracé,Coconuco,Belalcázar,Silvia,Inzá,Toribío,Tunía,Mosoco,Tumbichucue,Caldono,Santiago,Pancitará,Guachicono,Torres,SantaRosa,SanAntonio,Popayán,Poblazón,Vitoncó,Tacueyó,SantanderDeQuilichao,PuertoTejada,Bolívar,Caloto,Miranda,Corinto,Padilla,Piendamó"
},
{
    "name": "Pirahã",
  "i": 201327,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Caura,Ventuari,Auari,Roraima,BoaVista,Caracaraí,Mucajaí,Iracema,Normandia,Cantá,Anauá,Amaturá,SãoGabrielDaCachoeira,Cucuí,Marauá,Balawaque,Ye'kuana,Erebato,Toototobi,Parawa,Auaris,Surucucus,Ajarani,Xamatauteri,Catrimani,Demini,Aracacá,Inukuxi,Uataca,Homoxi,Hekura,Tamau,Iauitata,Wathau,Marauiá,SerraDosSurucucus,AltoOrinoco,Padamo,Ocamo,Mavaca,Waiká"
},
{
    "name": "Saramaccan",
  "i": 201329,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Pucallpa,Contamana,Masisea,Yarinacocha,Aguaytía,Tournavista,PuertoInca,SanAlejandro,Caimito,NuevaRequena,Campoverde,Manantay,Shanshococha,SantaClara,Callsao,RamónCastilla,Maquía,Neshuya,Sarayacu,Iparia,Panaillo,Lagunas,Jeberos,SantaRosaDePichan,Chazuta,Requena,Tahuayo,Nauta,VillaTierraBlanca,Parinari"
},
{
    "name": "Shuar",
  "i": 201331,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Sucúa,Gualaquiza,Logroño,Mendez,Santiago,Patuca,Taisha,Huamboya,Macas,Limón,Palora,PabloSexto,Tumbez,Zamora,Yantzaza,ElPangui,BuenaFe,Indanza,Tiwintza,NuevaTarqui,Chiguaza,Cuchillas,SevillaDeOro,Aguarico,Sangay,Upano,Chupiankas,SantaRosa,Chunchi,Gualaceo,Sigsig"
},
{
    "name": "Sirionó",
  "i": 201332,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "SãoPaulo,RioDeJaneiro,BeloHorizonte,Salvador,Fortaleza,Brasília,Curitiba,Recife,PortoAlegre,Goiânia,Manaus,Belém,SãoLuís,Teresina,JoãoPessoa,Natal,Cuiabá,CampoGrande,Florianópolis,Vitória,Aracaju,Maceió,Macapá,Palmas,BoaVista,PortoVelho,RioBranco,SãoJoséDosCampos,Santos,Campinas,Sorocaba,RibeirãoPreto,Araraquara,SãoJoséDoRioPreto,Bauru,PresidentePrudente,Londrina,Maringá,Joinville,Blumenau,Guarulhos,SãoBernardoDoCampo,SantoAndré,Osasco,Diadema,Itaquaquecetuba,Barueri,Carapicuíba,TaboãoDaSerra,EmbuDasArtes,Itapeva,Itu,Salto,Jundiaí,Piracicaba,Limeira,Americana,Sumaré,Hortolândia,Indaiatuba,Tatuí,Cerquilho,Itapetininga,Ourinhos,Assis,Marília,Franca,SãoCarlos,Jaboticabal,Araras,PresidenteVenceslau,Andradina,IlhaSolteira,Dracena,Penápolis,Botucatu,SãoManuel,Itapira,Mococa,PousoAlegre,Varginha,PoçosDeCaldas,SãoLourenço,CamposDoJordão,Taubaté,Guarapuava,Cascavel,FozDoIguaçu,FranciscoBeltrão,PatoBranco,Chapecó,Itajaí,Tubarão,Lages,Pelotas,Uruguaiana,SantanaDoLivramento,Bagé,RioGrande,Vacaria,CruzAlta,SantaCruzDoSul,CachoeiraDoSul,Santiago,SãoBorja,Alegrete,SãoGabriel,Ijuí,PassoFundo,Erechim,Carazinho,Veranópolis,BentoGonçalves,Canela,Gramado,Canelinha,BalneárioCamboriú,Itapema,CaxiasDoSul,Montevideo,BuenosAires,LaPaz,Lima,Bogotá,Caracas,Quito,Sucre,Asunción,Córdoba,Rosario,Mendoza,Tucuman,Salta,MarDelPlata,Bariloche,Valparaiso,Concepcion,Temuco,PuertoVaras,PuntaArenas,Ushuaia,Antofagasta,Iquique,Guayaquil,Cuenca,Ambato,Machala,Esmeraldas,Portoviejo,Riobamba,Loja,Ibarra,Quevedo,Babahoyo,LaLatacunga,Tulcán,SantoDomingoDeLosColorados,Otavalo,Cayambe,Pujilí,SanGabriel,Chunchi,Alausí,Guaranda,Azogues,Cañar,Macas,Gualaceo,Sigsig,Tena,Puyo,Archidona,ElChaco,Quijos,Baeza,SevillaDeOro,PuertoFranciscoDeOrellana,Loreto,Coca,Shushufindi,LaBonita,NuevaLoja,Sucumbíos,Pastaza,Morona,Chinchipe,Zamora,CentinelaDelCóndor,Yantzaza,Gualaquiza,Logroño,Sucúa"
},
{
    "name": "Warao",
  "i": 201336,
  ...
  "d": "lnrt",
  "m": 0,
  "b": "Tucupita,Pedernales,BarrancasDelOrinoco,Mariusa,Jobure,Curiapo,Manamo,Ajíes,Morichalito,SantaIsabelDeUtucual,CañoGuara,BocaGrande,CañoMontero,Cascajal,SanRafaelDeMay,LaHorqueta,CañoVenado,Winare,Manuare,Corozal,CañoChigüire,LosGallitos,Guayamure,Volcán,LaTortuga,BocaDeSerpiente,Tucupido,Yaguaraparo,Claret,Guiniquina"
},
{
    "name": "Warázu",
  "i": 201337,
...
},
{
  ...
  "d": "lnrt",
  "m": 0,
  "b": "PortoRealDoColégio,PalmeiraDosÍndios,Propriá,Aracaju,CanindéDeSãoFrancisco,Piranhas,DelmiroGoveia,OlhoDÁguaDoCasado,PoçoRedondo,SantanaDoSãoFrancisco,Traipu,CedroDeSãoJoão,SãoBrás,Itabi,NossaSenhoraDeLourdes,CampoGrande,Gararu,Monteirópolis,FeiraGrande,MajorIsidoro,Batalha,JacaréDosHomens,SantoAntônio,BeloMonte,Cumbe,Entremontes,Itaoca,Carneiros,SãoMiguelDosCampos,Penedo"
},
{
    "name": "Yaminawa",
  "i": 201340,
