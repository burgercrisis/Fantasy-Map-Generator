...
window.asiaNameBases = [
     ...
     "b": "Lamjung,Gorkha,Sundarbazar,Dulegauda,Khudi,Bhoteodar,Bharatpur,Abukhaireni,Khanikhola,Ambukhaireni,Tanahun,Purkot,Bāṅgre,Besī Bāṅgre,Besī Phā̃ṭ,Sindure,Dhusenī,Naske,Neṭā,Candigāũ,Bhāṅgu,Māliṅ,Ārīkose,Ṭhūlo Svā̃rā,Khaje Gāũ,Turluṅ,Tāndrāṅkoṭ,Kunchha,Bhorletar,Tāndrāṅ,Pokharī Thok,Jītā,Duradanda,Turlungkot,Thuloswara,Sisaghat,Ramche,Dharampani,Tanahusar,Kyamin"},
  {
    ...
    "d": "lnrt",
    "m": 0,
      "b": "Samtse,Haa,Phuentsholing,Gomtu,Sibsu,Tashicholing,Tendu,Chengmari,Pugli,Jigme,Singye,Wangchuck,Samchi,Damtey,Loto Kuchu,Lotu,Sanglong,Sataka,Taba"},
  {
    "name": "Korean",
    "i": 9,
    "min": 5,
  ...
  {
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Vilna,Warsaw,Krakow,Lodz,Lublin,Minsk,Odessa,Kiev,Lviv,Vilnius,Kaunas,Berdichev,Zhitomir,Vitebsk,Gomel,Grodno,Bialystok,Brest,Pinsk,Bialystok,Chelm,Radom,Siedlce,Piotrkow,Kielce,Czestochowa,Sosnowiec,Katowice,Przemysl,Tarnow,Rzeszow,Vinnitsa,Proskurov,Kishinev,Belz,Satmar,Munkacs,Ungvar,Presov,Satu Mare,Iasi,Bucharest,Budapest,Miskolc,Debrecen,Szeged,Kosice,Bratislava,Prague,Brno"}
  , {
...
module.exports = window.asiaNameBases;
