...
window.europeNameBases = [
  ...
  },
  {
    ...
    "d": "nic-GH",
    "m": 0,
    "b": "Kyiv,Kharkiv,Odesa,Dnipro,Donetsk,Zaporizhzhia,Lviv,Kryvyi Rih,Mykolaiv,Mariupol,Vinnytsia,Kherson,Chernihiv,Poltava,Cherkasy,Sumy,Zhytomyr,Rivne,Khmelnytskyi,Chernivtsi,Ivano-Frankivsk,Ternopil,Lutsk,Uzhhorod,Bila Tserkva,Kamianets-Podilskyi,Brovary,Boryspil,Melitopol,Berdiansk,Nikopol,Kramatorsk,Sloviansk,Pavlohrad,Severodonetsk,Konotop,Shostka,Nizhyn,Kremenchuk,Kropyvnytskyi,Uman,Lysychansk,Horlivka"
  },
  {
    "name": "Irish Gaelic",
    "i": 76,
  ...
  },
  {
    ...
    "d": "nic-GH",
    "m": 0,
    "b": "Inverness,Stornoway,Portree,Oban,Fort William,Thurso,Wick,Kirkwall,Lerwick,Scalloway,Elgin,Nairn,Dornoch,Tain,Ullapool,Lochinver,Tobermory,Broadford,Mallaig,Ballachulish,Invergordon,Inverurie,Peterhead,Fraserburgh,Stonehaven,Campbeltown,Lochgilphead,Rothesay,Dunoon,Helensburgh,Ardrishaig,Crinan,Portnahaven,Bowmore,Port Ellen,Bunessan,Tarbert,Arisaig,Spean Bridge,Aviemore,Kingussie,Grantown,Lairg,Gairloch,Poolewe,Applecross,Kinlochbervie,Durness,Bettyhill,Melvich,Golspie,Brora,Lossiemouth,Banff,Macduff,Fortrose,Glasgow,Edinburgh,Aberdeen,Dundee,Perth,Stirling,Dunfermline,Dumbarton,Cumbernauld,Airdrie,East Kilbride,Livingston,Hamilton,Clydebank,Coatbridge,Greenock,Paisley,Glenrothes,Falkirk, Kilmarnock,Ayr,Irvine,Renfrew,Larbert,Bridge of Allan,Dunkeld,Blairgowrie,Aboyne,Ballater,Banchory,Alford,Huntly,Keith,Dufftown,Forres,Carrbridge,Newtonmore,Dalwhinnie,Blair Atholl,Kenmore,Tummel Bridge,Ruthven,Invergarry,Fort Augustus,Drumnadrochit,Beauly,Conon Bridge,Muir of Ord,Tongue,John O'Groats,Lybster,Dunbeacon,Kylerhea,Plockton,Dornie,Kyle of Lochalsh,Shiel Bridge"
  },
  {
  ...
  },
  {
    ...
    "d": "nic-GH",
    "m": 0,
    "b": "Kuala Lumpur,Putrajaya,Shah Alam,Klang,Petaling Jaya,Subang Jaya,Cyberjaya,Seremban,Port Dickson,Melaka,Alor Gajah,Ayer Keroh,Johor Bahru,Batu Pahat,Muar,Kluang,Kulai,Kota Tinggi,Segamat,Kuantan,Temerloh,Bentong,Jerantut,Kuala Terengganu,Kemaman,Dungun,Marang,Kota Bharu,Bachok,Pasir Mas,Tumpat,Ipoh,Taiping,Teluk Intan,Lumut,Kuala Kangsar,George Town,Butterworth,Bukit Mertajam,Kulim,Sungai Petani,Alor Setar,Kangar,Kajang,Kota Kinabalu,Sandakan,Tawau,Pekan,Arau,Kubang Kerian"
  },
  {
    "name": "Berau Malay",
    "i": 102,
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Zürich,Basel,Bern,Lucerne,St. Gallen,Winterthur,Thun,Zug,Schaffhausen,Chur,Fribourg,Aarau,Solothurn,Biel,Wil,Frauenfeld,Rapperswil-Jona,Emmen,Köniz,Kriens,Wädenswil,Uster,Dübendorf,Dietikon,Horgen,Wetzikon,Olten,Gossau,Schwyz,Bellinzona,Baden,Sion,Vernier,Allschwil,Renens,Montreux,Nyon,Bulle,Pratteln,Rheinfelden"
  },
  {
