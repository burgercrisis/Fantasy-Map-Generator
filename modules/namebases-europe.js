...
window.europeNameBases = [
  ...
  },
  {
    ...
    "d": "lnrt",
    "m": 0,
    "b": "Gällivare,Kiruna,Jokkmokk,Arjeplog,Luleå,Piteå,Älvsbyn,Boden,Skellefteå,Arvidsjaur,Dorotea,Vilhelmina,Strömsund,Östersund,Sveg,Hammarstrand,Åre,Krokom,Bräcke,Ockelbo,Sandviken,Gävle,Hudiksvall,Ljusdal,Söderhamn,Bollnäs,Ovanåker,Nordanstig,Järvsö,Åsele,Ånge,Vännäs,Sollefteå,Lycksele,Sorsele",
    "status": "COMPLETE"
  },
  {
    "name": "Gagauz",
...
,
      ...
      {"name": "Romani", "i": 20257, "min": 4, "max": 12, "d": "", "m": 0, "b": "Strehaia,Tandarei,Slobozia,Constanta,Bucharest,Catelu,Buzescu,Glodeanu-Silistea,Slobozia Bradului,Barbulesti,Toflea,Pata-Rat,Ferentari,Sacele,Zanea,Medveja,Cociulia,Trebujeni,Cartojani,Nojorid,Baciu,Fata Luncii,Mimiu,Siretu,Dealul Viilor,Rudari,Garcini,Ponorata,Ocolna,Crucea,Valea Corbului,Salcuta,Ormenis,Pistestii din Deal,Chelinta,Bagaciu,Radoaia,Dudasu,Stana,Tonciu,Arini,Maguri,Augustin,Valea Hotarului,Viile Tecii,Gura Pravat,Plaiu Campinei,Zece Prjani,Mirza,Liesti,Budacu de Jos,Lespezi,Beica,Nemsa,Ferendia,Stoenesti,Babeni,Budesti,Plenita,Carcea,Cotofenii din Dos,Gighera,Tuglui,Plopsorelu,Malu Mare,Craiova,Ploiesti,Bacau,Botosani,Iasi,Cluj-Napoca,Timisoara,Sibiu,Oradea,Baia Mare,Satu Mare,Suceava,Arad,Galati,Buzau,Targoviste,Giurgiu,Alexandria,Turnu Severin,Caransebes,Lugoj,Resita,Barlad,Calarasi,Tulcea,Medgidia,Mangalia,Sfantu Gheorghe,Salonta,Beius,Sebes,Aiud,Blaj,Medias,Codlea,Zarnesti,Rasnov,Fagaras,Odorheiu Secuiesc,Miercurea Ciuc,Toplita,Gheorgheni,Nadezhda,Sheker,Gradets,Mladen,Pavel Banya,Maglizh,Strazha,Brezhani,Dolni Tsibar,Kozloduy,Pleven,Varna,Burgas,Ruse,Stara Zagora,Sliven,Shumen,Dobrich,Silistra"},
...
,
        {"name": "Yiddish", "i": 24788, "min": 4, "max": 12, "d": "", "m": 0, "b": "Vilnius,Vilna,Varshe,Warsaw,Varsha,Krakow,Krakov,Lodz,Lublin,Lvov,Lviv,Lemberg,Odessa,Kyiv,Kharkiv,Minsk,Brest,Brisk,Grodno,Vitebsk,Pinsk,Berdichev,Uman,Zhitomir,Zolochiv,Kolomea,Chernivtsi,Czernowitz,Kamianets-Podilskyi,Bohorodchany,Dolyna,Stryi,Drohobych,Sambir,Novoyavorivsk,Shehyni,Mostyska,Rava-Ruska,Rakhiv,Mukachevo,Berehove,Uzhhorod,Velykyi,Bereznyi,Satmar,Brooklyn,Manhattan,Williamsburg,Kiryas,Joel,Lakewood,Monsey,Boro,Montreal,Outremont,Antwerp,Brussels,Amsterdam,London,Tel,Aviv,Jerusalem,Haifa,Bnei,Brak,Petah,Tikva,Rishon,LeZion,Buenos,Aires,Cordoba,Rosario,Bahia,Blanca,Budapest,Vienna,Prague,Berlin,Paris,Bucharest"},
      {"name": "Dalmatian", "i": 24789, "min": 4, "max": 12, "d": "lr", "m": 0.1, "b": "Zadar,Spalato,Split,Ragusa,Dubrovnik,Sebenico,Sibenik,Trau,Trogir,Lesina,Hvar,Curzola,Korcula,Lissa,Vis,Almissa,Omis,Makarska,Ploce,Metkovic,Cavtat,Konavle,Vrgorac,Imotski,Signo,Sinj,Tnin,Knin,Drnis,Scardona,Skradin,Vodice,Biograd,Moru,Pago,Pag,Arbe,Rab,Cherso,Cres,Lussino,Lussinpiccolo,Mali,Losinj,Veli,Pola,Pula,Rovigno,Rovinj,Parenzo,Porec,Umago,Umag,Cittanova,Novigrad,Buie,Buje,Pinguente,Buzet,Albona,Labin,Abbazia,Opatija,Crikvenica,Segna,Senj,Otocac,Gospic,Gracac,Benkovac,Obrovac"},
      {"name": "Emilian", "i": 24790, "min": 4, "max": 12, "d": "lr", "m": 0.1, "b": "Bologna,Modena,Parma,Piacenza,Reggio,Emilia,Ferrara,Forlí,Cesena,Rimini,Ravenna,Faenza,Imola,Carpi,Sassuolo,Scandiano,Casalecchio,di,Reno,San,Lazzaro,Savena,Valsamoggia,Castel,Giovanni,Fidenza,Fiorenzuola,d-Arda,Salsomaggiore,Terme,Busseto,Secondo,Parmense,Fontanellato,Soragna,Noceto,Medesano,Collecchio,Sala,Baganza,Felino,Langhirano,Traversetolo,Polo,d-Enza,Canossa,Reggiolo,Guastalla,Novellara,Correggio,Martino,in,Rio,Rubiera,Campogalliano,Soliera,Bastiglia,Bomporto,Ravarino,Nonantola,Castelfranco,sul,Panaro,Savignano,Vignola,Marano"},
...
,
        {"name": "Maltese", "i": 25011, "min": 4, "max": 12, "d": "", "m": 0, "b": "Valletta,Sliema,Birkirkara,Mosta,St.Pauls,Bay,San,Giljan,Naxxar,Gzira,Rabat,Mellieha,Birgu,Marsaxlokk,Senglea,Cospicua,Paola,Qormi,Zebbug,Zejtun,Attard,Zurrieq,Marsascala,Hamrun,Tarxien,Iklin,Luqa,Kirkop,Mgarr,Safi,Bidnija,Wardija,Manikata,Pembroke,Victoria,Nadur,Xaghra,Xewkija,Qala,Gharb,Ghasri,Sannat,Fontana,Kercem,Marsalforn,Xlendi,Munxar,Msida,Ta,Xbiex,Pieta,Fgura,Marsa,Floriana,Kalkara,Balzan,Lija,Dingli,Imdina,Siggiewi,Qrendi,Gudja,Marsaskala,Birzebbuga,Zabbar,Xghajra,Comino,Bugibba,Qawra,Salina,Xemxija,St.Paul,Bahar,ic-Caghaq,Madliena,Swieqi,Gwann,Kappara,St,Andrews,Mriehel,Venera,Tal-Pieta,Popeye,Anchor,Golden,Paradise,Armier,Cirkewwa,Pauls,Julians,Paceville,Georges,Spinola,Swatar,Bahrija,Kuncizzjoni,Smart,City,Qali,Hal,Mtahleb,Imtahleb,Mtarfa"},
